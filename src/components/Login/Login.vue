<template>
  <div class="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#1a1714]">
    ...
    >
      <div class="mb-1 font-['DM_Serif_Display',serif] text-[22px] text-[#1a1714]">
        Clinical Trial <span class="italic text-[#2a5c8f]">Data Exchange</span>
      </div>
      <div class="mb-7 font-['DM_Mono',monospace] text-[10px] uppercase tracking-[.14em] text-[#6b6560]">
      ...
      <label class="mb-[5px] block text-[11px] font-semibold uppercase tracking-[.08em] text-[#6b6560]">
        Email Address
      </label>
      <input
        v-model="email"
