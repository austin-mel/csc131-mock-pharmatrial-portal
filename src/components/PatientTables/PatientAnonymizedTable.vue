...
import { DataCard, DataTable, DoseBar, StatusBadge } from "@/components";
            ...
            >
                <div class="mb-2 flex items-start justify-between gap-3">
                    <div class="min-w-0">
                        ...
                        <div
                            v-if="showClinicalData"
                            class="mt-1 text-[13px] text-ink"
                        >
                            {{ display(patient).icdCodes }}
                        </div>
                    </div>
