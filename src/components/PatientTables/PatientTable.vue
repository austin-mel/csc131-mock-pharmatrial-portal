        ...
        <DataTable class="max-[520px]:hidden">
            <thead>
                <tr>
                    ...
                    <th v-if="showEligibility" class="hidden md:table-cell">
                        Eligible
                    </th>
                    <th>Doses</th>
                    <th>Actions</th>
            ...
            <tbody>
                ...
                >
                    ...
                    <td class="hidden md:table-cell">
                        {{ display(patient).icdCodes }}
                    </td>
                    <td v-if="showEligibility" class="hidden md:table-cell">
                        <StatusBadge
                            :tone="
                                enrollments[patient.id]?.eligible
                                    ? 'green'
                                    : 'gray'
                            "
                        >
                    ...
                    <td
                        class="flex min-w-[160px] flex-wrap gap-1.5 max-[640px]:min-w-[140px]"
                        @click.stop
                    >
                        <ActionButton
            ...
            >
                <div class="mb-2 flex items-start justify-between gap-3">
                    ...
                    <StatusBadge
                        ...
                        :tone="
                            enrollments[patient.id]?.eligible ? 'green' : 'gray'
                        "
                    >
                        {{ display(patient).eligibilityLabel }}
                    </StatusBadge>
                ...
                <div class="grid gap-2 text-[13px] text-muted">
                    <div>
                        <span
                            class="font-mono text-[10px] uppercase tracking-[.12em]"
                            >DOB</span
                        >
                ...
                <div class="mt-3 grid grid-cols-2 gap-2" @click.stop>
                    <ActionButton @click="$emit('detail', patient.id)"
                        >View</ActionButton
                    >
                    <ActionButton
                        v-if="canEdit"
