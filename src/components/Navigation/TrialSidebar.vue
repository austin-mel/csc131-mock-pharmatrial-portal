...
<template>
    ...
    >
        <div
            class="grid min-w-0 gap-2 border-b border-rule px-[18px] pb-2.5 pt-4"
        >
            <div class="flex items-center justify-between gap-2">
                <div
                    class="font-mono text-[9px] uppercase tracking-[.18em] text-muted"
                >
                    Clinical Trials
                </div>
                <button
            ...
            />
            <SegmentedControl v-model="filterModel" :options="filterOptions" />
            <ActionButton
