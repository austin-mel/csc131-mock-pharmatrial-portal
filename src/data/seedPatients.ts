    ...
    "TRL-2023-001": {
        "a3f9-2c11": {
            ...
            appointments: [
                ...
                },
                {
                    ...
                    dose: true,
                    bloodTestLevel: 92,
                    adverseEvents: ["Mild fatigue"],
                    note: "Dose administered.",
                },
                {
                    date: "2023-09-01",
                    type: "Dose Administration",
        ...
        "b7d2-8e44": {
            ...
            appointments: [
                ...
                {
                    date: "2023-08-03",
                    type: "Follow-up Evaluation",
                    dose: false,
                    bloodTestLevel: 105,
                    adverseEvents: ["Headache"],
                    note: "Follow-up.",
                },
            ],
        },
            ...
            Array.from({ length: 22 }, (_, index) => {
                ...
                return [
                    patientId,
                    {
                        ...
                        appointments: [
                            {
                                date: `2023-07-${String((index % 20) + 5).padStart(2, "0")}`,
                                type: "Initial Screening",
                                dose: false,
                                bloodTestLevel: 115 - (index % 9),
                                adverseEvents: [],
                                note: "Demo baseline visit.",
                            },
                            {
                                date: `2023-08-${String((index % 20) + 5).padStart(2, "0")}`,
                                type: "Dose Administration",
                                dose: true,
                                bloodTestLevel: 101 - (index % 8),
                                adverseEvents:
                                    index % 5 === 0 ? ["Mild fatigue"] : [],
                                note: "Demo dose visit.",
                            },
                        ],
                    },
                ];
